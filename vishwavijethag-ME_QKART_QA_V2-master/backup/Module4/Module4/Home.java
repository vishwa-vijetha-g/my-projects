...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(
                ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 css-sycj1h']")),
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            //removed WebElement cartParent = driver.findElement(By.className("cart"));
            //added
            WebElement cartParent = driver.findElement(By.xpath("//div[@class='cart MuiBox-root css-0']"));

            //removed List<WebElement> cartContents = cartParent.findElements(By.className("css-zgtx0t"));
            //added
            ...
            for (WebElement cartItem : cartContents) {
                //removed actualCartContents.add(cartItem.findElement(By.className("css-1gjj37g")).getText().split("\n")[0]);
                //added 
