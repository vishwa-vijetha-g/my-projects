...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            //Thread.sleep(3000);
            //Adding a wait statement instead of sleep
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.or(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h4[text()=' No products found ']")), ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='MuiCardContent-root css-1qw96cp']"))));
                    ...
                    if(productName.equals(cartItem.findElement(By.xpath(".//div")).getText())){
                        ...
                        while(quantity!=cartQuantity){
                            if(cartQuantity<quantity){
                                ...
                                //Thread.sleep(5000);
                                //wait.until(ExpectedConditions.textToBe(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/div"), String.valueOf(cartQuantity++)));
                                wait.until(ExpectedConditions.textToBePresentInElement(cartItem.findElement(By.xpath(".//div[2]/div[1]/div")), String.valueOf(cartQuantity+1)));
                                cartQuantity++;
                            }
