...
public class Checkout {
    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            //Thread.sleep(5000);
            Integer listSize = driver.findElements(By.xpath("//*[@id='root']/div/div[2]/div[1]/div/div[1]/div/div[1]/p")).size();
            WebDriverWait wait = new WebDriverWait(driver, 5);
            wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[@id='root']/div/div[2]/div[1]/div/div[1]/div["+ String.valueOf(listSize) +"]/div[1]/p"), addresString));
            return true;
        } catch (Exception e) {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            //optimization 2 - susp - Thread.sleep(3000);
    ...
    public Boolean placeOrder() {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,5);
            wait.until(ExpectedConditions.or(ExpectedConditions.urlContains("/thanks"),ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar"))));
            return true;
