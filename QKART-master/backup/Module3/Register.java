...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        WebDriverWait wait = new WebDriverWait(driver, 5); // changing timeout to 15 sec because registration process is taking lot of time
        
        wait.until(ExpectedConditions.or(ExpectedConditions.urlToBe("https://crio-qkart-frontend-qa.vercel.app/login"),ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar"))));
